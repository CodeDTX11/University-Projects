...
####################(2)####################
					addi $a0, $sp, 0	# reply address
					addi $a1, $sp, 56	# dm prompt
...
# Register Usage:
#################
# $t0 holds copy of char address
#################
#   cout << prompt;
#   cin >> *charVarToPutInPtr;

####################(7)####################
					move $t0, $a0	#save char to t0
					
					move $a0, $a1	 #move promt to a0
					li $v0, 4
					syscall
